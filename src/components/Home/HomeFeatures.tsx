    ...
    return (
        <>
            <div className="HomeFeaturesDiv">
                <div className="FeaturesTitleHolder">
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <div className="FeatureText">
                        <span className="SpanHeader" style={{ paddingBottom: '30px' }}>Focused Analysis Areas</span>
                ...
                <div className="FeatureText">
                        <span className="SpanHeader" style={{ paddingBottom: '30px' }}>User-Driven Customization</span>
                    ...
                    <div className="FeatureLogo">
                        <img src={UserDrivenCustomizationLogo} alt="UserDrivenCustomizationLogo" style={{ maxWidth: '100%', height: 'auto' }} />
                    </div>
                </div>
                <div className="FeatureHolder">
                <div className="FeatureText">
                        <span className="SpanHeader" style={{ paddingBottom: '30px' }}>Instant Insights</span>
                    ...
                    <div className="FeatureLogo">
                        <img src={InstantInsightsLogo} alt="InstantInsightsLogo" style={{ maxWidth: '100%', height: 'auto' }} />
                    </div>
                </div>
                <div className="FeatureHolder" style={{backgroundColor:"white"}}>
                <div className="FeatureText">
                        <span className="SpanHeader" style={{ paddingBottom: '30px', paddingTop: '60px' }}>How It Works</span>
                        <span className="SpanContent">
                            <ol style={{ paddingLeft: '0px', marginLeft: '0px', color: "#657383", listStylePosition: 'inside' }}>
                                <li className="mt-2">
                    ...
                    <div className="FeatureLogo">
                        <img src={HowItWorksLogo} alt="Dashboard" style={{ maxWidth: '100%', height: 'auto' }} />
                    </div>
                </div>

                <div className="FeatureHolder" style={{flexDirection: 'column', paddingTop: '60px', paddingBottom:'50px', marginBottom:'100px' }}>
